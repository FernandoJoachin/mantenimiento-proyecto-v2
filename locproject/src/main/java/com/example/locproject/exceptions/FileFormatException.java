...
public class FileFormatException extends Exception {
     ...
     */
    public FileFormatException(String fileName, int lineNumber, String errorMessage, String lineContent) {
     ...
     */
    private static String createMessage(String fileName, int line, String errorMessage, String content) {
